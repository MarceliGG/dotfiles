...
function Workspaces({ orientation }) {
  ...
  return /* @__PURE__ */ jsxs("box", { className: "workspaces", orientation, children: [
    ...
    bind(hypr, "focusedClient").as((client) => {
      if (client)
        return /* @__PURE__ */ jsx("label", { ellipsize: 3, label: bind(client, "title").as((t) => t || client.initialTitle || client.class), css: "margin-right: 40px" });
      else
        return "";
    })
  ] });
